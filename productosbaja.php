...
<html lang="en">
  <head>
    ...
    <title>Kmoda - Productos de Baja</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <div class="app-title">
        <div>
          <h3><i class="fa fa-th-list"></i> Productos dados de baja</h3>
          <p>Productos que han sido separados de nuestro stock por diferentes motivos</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="productos.php">Productos</a></li>
          <li class="breadcrumb-item">Productos de Baja</li>
        </ul>  
      </div>
...
<div class="row">
        ...
        <a href="productos.php" > <div class="widget-small primary coloured-icon"><i class="icon fa fa-cart-plus fa-3x"></i></a>
            <div class="info">
              <h4>Mis Productos</h4>
        ...
        <div class="col-md-12">
          <div class="tile">
            <div class="panel-body">
              ...
              <?php
                      $sqlcount="SELECT count(*) cant FROM producto WHERE estado = 0";
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  <thead>
                   ...
                   <tbody style="cursor:pointer">
                                     ...
                                     <?php
                                  $sql="SELECT p.id_producto , pr.nombre_pr , cat.nombrecateg , p.nombre_producto, p.talla , p.color , p.stock , p.precio, p.motivo
                                        from producto p 
                                  ...
                                  while($reg=$result->fetchObject()){
                                    echo "<tr>
                                        ...
                                        <td align=center >
                                        <a href='habilitarproducto.php?id_producto=$reg->id_producto'><button type='button' class = 'btn btn-info'> <i class='fa fa-undo'></i></button></a></td>
