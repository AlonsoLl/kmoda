...
<html lang="en">
  <head>
    ...
    <title>KModa - Compras por Confirmar</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <div class="app-title">
        <div>
          <h3><i class="fa fa-th-list"></i> Compras por Confirmar</h3>
          <h5>La compra se confirma una vez que completamos los pedidos, para separar productos especificos, o por evaluación de menor precio</h5>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Compras por Confirmar</li>
        </ul>
      </div>

      <?php
                      $sqlcount="SELECT SUM(cuenta) cant FROM compras where estado=0";
      ...
      <div class="widget-small info coloured-icon"><i class="icon fa fa-usd fa-3x"></i>
        ...
        <div class="col-md-6 col-lg-3">
        <a href="compras.php" > <div class="widget-small warning coloured-icon"><i class="icon fa fa-thumbs-o-up fa-3x"></i> </a>
            <div class="info">
              <h4>Confirmadas</h4>
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  <thead>
                    ...
                    <tr>
                                            ...
                                            <th style="text-align: center; background-color:#82E0AA">Total Compra</th>
                                            <th style="text-align: center; background-color:#85C1E9">Precio Venta</th>
                   ...
                   <tbody style="cursor:pointer">
                                  ...
                                  while($reg=$result->fetchObject()){
                                    echo "<tr>
                                        ...
                                        <td align=center >
                                        <a onclick='verCompraOk($reg->id_compra)' data-toggle='modal' data-target='#myModal1'><button type='button' class='editar btn btn-info'><i class='fa fa-pencil-square-o'></i>  </button></a>	
                                        <a onclick='confirmarCompra($reg->id_compra)' data-toggle='modal' data-target='#myModal4'> <button type='button' class='eliminar btn btn-primary' data-toggle='modal' data-target='#modalEliminar' ><i class='fa fa-check'></i></button></a>
                                  ...
                                  <!-- FIN ENLAZAR TABLAS PARA CAMBIAR EL CODIGO POR NOMBRE DE PROVEEDOR Y CATEGORIA -->
                                                        ...
                                                        <!-- MODAL EDITAR--> 
                                                        <form action="editarcomprasporconfirmar.php" method="post">
                                                                                                      ...
                                                                                                      <div class="panel-body">
                                                                                                          ...
                                                                                                          <div class="modal-body">
                                                                                                                ...
                                                                                                                <!-- INICIO LLENO EL COMBO BOX DE PROVEEDOR -->
                                                                                                                    ...
                                                                                                                    <div class="form-row">
                                                                                                                      ...
                                                                                                                      <div class="form-group">
                                                                                                                          ...
                                                                                                                          <input name="prod" id="prod" class="form-control" placeholder="Escriba el nombre del Producto"
                                                                                                                          required>
                                                                                                                      </div>
                                                                                                                ...
                                                                                                                <div class="form-row">
                                                                                                                      ...
                                                                                                                      <div class="col" class="form-group">
                                                                                                                          <label>Total (*)</label>
                                                                                                                          <input name="tot" id="tot" class="form-control amt" type="number" readonly
                                                                                                                          step="0.01"
                                                                                                                         >
                                                                                                                      </div>
                                                                                                                </div>
                                                                                                                ...
                                                                                                                <div class="col" class="form-group">
                                                                                                                          ...
                                                                                                                          <input name="cuen" id="cuen" class="form-control amt" type="number" 
                                                                                                                          step="0.5"
                                                                                                                          value="0.00"
                                                                                                                         />
                                                                                                                      </div>
                                                                                                                      <div class="col" class="form-group">
                                                                                                                          <label>Saldo </label>
                                                                                                                          <input name="sal" id="sal" class="form-control" type="number" readonly
                                                                                                                          step="0.5"
                                                                                                                          value="0.00"
                                                                                                                         />
                                                                                                                      </div>
                                                                                                                ...
                                                                                                                <div class="col" class="form-group">
                                                                                                                          <label>Flete</label>
                                                                                                                          <input name="fle" id="fle" class="form-control" type="number" 
                                                                                                                          step="0.5"
                                                                                                                          value="0.00"
                                                                                                                         />
                                                                                                                      </div>
                                                                                                                      <div class="col" class="form-group">
                                                                                                                          <label>Pasajes</label>
                                                                                                                          <input name="pas" id="pas" class="form-control" type="number"
                                                                                                                          step="0.5"
                                                                                                                          value="0.00"
                                                                                                                         />
                                                                                                                      </div>
                                                                                                      ...
                                                                                                      <div class="panel-body">
                                                                                                          ...
                                                                                                          <div class="modal-body">
                                                                                                                  <form role="form">
                                                                                                                      <div  class="form-group">
                                                                                                                          <label></label>
                                                                                                                          <input style="width: 120px" name="codigocompra" id="codigocompra" class="form-control" hidden readonly >
                                                                                                                      </div>
                                                                                                                    
                                                                                                                      <div class="col" class="form-group">
                                                                                                                          <label><h5>    Desea confirmar la compra de: </h5> </label>
                                                                                                                          <input name="productoOk" id="productoOk" class="form-control"
                                                                                                                          readonly>
                                                                                                                      </div>
                                                                                                                      <br/>
