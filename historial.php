    ...
    <aside class="app-sidebar">
      ...
      <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb side">
         ...
         <li class="breadcrumb-item">Historial de Pedidos</li>
        </ul>
      </div>
                  ...
                  <thead>
                    ...
                    <th style="text-align: center">Fecha de Reserva</th>
                                          <!--  <th style="text-align: center">Producto(s)</th> -->
                                            ...
                                            <th style="text-align: center; background-color:#27AE60">A cuenta</th>
                                            <th style="text-align: center; background-color:#CD6155">Saldo</th>
                   ...
                   <tbody style="cursor:pointer">
                                     ...
                                     <?php
                                  $sql="SELECT DISTINCT c.nombres AND pe.id_producto, pe.cantidad, p.precio, (pe.cantidad*p.precio)  FROM pedido pe
                                  ...
                                  while($reg=$result->fetchObject()){
                                    echo "<tr>
                                        ...
                                        <td style=background-color:#27AE60; align=center ><h6> S/. $reg->cantidad_pago</td></h6>
                                        <td style=background-color:#CD6155; align=center ><h6> S/. $reg->saldo</td></h6>
                                                  ...
                                                  <div class="modal-dialog modal-dialog-centered"> <!-- para modal mas ancho es modal-lg y para modal mas estrecho es modal-sm, dentro del class modal dialog-->
                                                      ...
                                                      <div class="form-row">  
                                                                ...
                                                                <div class= "col" class="form-group">
                                                                          ...
                                                                          <input name="cantidpagos" id="cantidpagos" class="form-control" id="exampleInputPassword1" type="number" min='1'
                                                                          step="0.5"
                                                                          required>
                                                                    </div>
                                                                    ...
                                                                    <div class= "col" class="form-group">
                                                                          ...
                                                                          <input name="cantcue" id="cantcue" class="form-control" id="exampleInputPassword1" type="number" min='1'
                                                                          disabled
                                                                          value="0.00"
                                                                          required>
                                                                    </div>
                                                                ...
                                                                <div class="col" class="form-group">
                                                                            <label>Modalidad de Pago</label>
                                                                                  <select name="modpag" id="modpag" class="form-control" >
                                                                                      <?php
                                                                    ...
                                                                    <div class="col" class="form-group">
                                                                          <label>Estado de Pedido</label>
                                                                                <select  name="estped" id="estped" class="form-control"  >
                                                                                    <?php
